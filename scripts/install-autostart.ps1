...
Write-Host ""
Write-Host "Before login autostart can use AI features, make sure these are persisted as user env vars:"
Write-Host "  MYCLAW_MODEL_PROVIDER"
Write-Host "  MYCLAW_MODEL_BASE_URL"
Write-Host "  MYCLAW_MODEL_API_KEY"
Write-Host "  MYCLAW_MODEL_NAME"
